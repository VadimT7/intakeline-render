...
function narrate() {
  ...
  // Vadim's chosen dial: stability 1.0, similarity 0.80, style 0.20, speed 1.0.
  const vs = { stability: 1.0, similarity_boost: 0.80, style: 0.20, use_speaker_boost: true, speed: 1.0 };
